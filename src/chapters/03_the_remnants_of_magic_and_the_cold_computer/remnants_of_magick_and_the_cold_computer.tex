...
\else
    \chapter{The Remnants of Magic and The Cold Computer}
    It has been a long time since Neuro-Linguistic Programming (NLP) was dismissed as an irreproducible pseudoscience. Observing how it was banished from academic shelves and reduced to mere merchandise for self-help seminars, many have likely concluded with disappointment that it was just a fraud after all. Others, clinging to isolated superficial techniques such as rapport or the yes-set, naively convince themselves that it works.

    Yet, those who know the reality on the ground know better.
    We have witnessed firsthand the overwhelming ``magic'' wielded by Dr.~Richard Bandler. Severe phobias evaporate in an instant; deeply entrenched beliefs held for decades are dismantled and restructured within minutes of dialogue. With a single gesture of his finger or a subtle shift in vocal tone, the subject's entire perceptual space is warped. He is, without question, the real thing.

    Yet—why is it that when we recite the exact same scripts and trace the identical hypnotic language patterns, we fail entirely to induce a trance? Why do others refuse to follow our lead, leaving us repelled by the unyielding wall of reality?

    The answer is brutally simple.
    We were merely mimicking the surface illusions of the magic trick—the superficial language—without understanding an ounce of the physical laws governing the biological information-processing hardware he was actually hacking.

    To strip NLP of its veil of mysticism and claim it as a true engineering discipline, we require a cold, critical intellect capable of questioning our self-evident assumptions about the ``mind'' and the ``unconscious.''

    To strip NLP of its veil of mysticism and claim it as a true engineering discipline, we require a cold, critical intellect that questions not only our taken-for-granted assumptions regarding the ``mind'' and the ``unconscious,'' but even the foundational premises asserted by the framework of NLP itself.

    Before we begin revealing the tricks behind the curtain, let us first define the minimal mathematical and information-theoretic protocols required to describe the operational principles of this biological computer.
\fi
...
ここで $P(A \cap B)$ は事象 $A$ と事象 $B$ が同時に生起する同時確率を表す。この定義式を変形すると、確率の乗法定理が得られる。
\begin{equation}
