...
\newcommand{\MathNumHypotheses}{K}

\newcommand{\ConditionalProbability}[2]{P( #1 \mid #2 )}
\newcommand{\Probability}[1]{P( #1 )}

\newcommand{\postfixIndexOne}{i}
\newcommand{\postfixIndexTwo}{j}
\newcommand{\postfixIndexThree}{k}
\newcommand{\postfixIndexFour}{l}
\newcommand{\postfixIndexFive}{m}
...
% ====================================================================
% WholeSelf:ウロボロス記号 (Vector PDF版)
% ====================================================================
\newcommand{\Ouroboros}{%
  \mathord{%
    \vcenter{\hbox{%
      \includegraphics[height=2.5ex]{src/images/Ouroboros.pdf}%
    }}%
  }%
}
