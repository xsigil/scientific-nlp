...
Scientific NLP\texttrademark 創始者。ベイジアンハッカー。東京大学大学院理学系研究科物理学専攻修士課程修了。在学時は高エネルギー加速器研究機構（KEK）にて研究に従事。コンピューターエンジニアを経て、脳科学・ベイズ統計・情報幾何学・サイバネティクスを統合した決定論的認知科学アプローチ「Scientific NLP\texttrademark」を体系化。
