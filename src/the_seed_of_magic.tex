...
\begin{align}
    \tilde{\Omega}^{\mathrm{ego}}{\mathrm{cause}} &\equiv \tilde{\Omega}^{\mathrm{ego}}{\mathrm{cause:profit}} \cup \tilde{\Omega}^{\mathrm{ego}}{\mathrm{cause:threat}} \cup \tilde{\Omega}^{\mathrm{ego}}{\mathrm{cause:neutral}} \
    \tilde{\Omega}^{\mathrm{ego}}{\mathrm{causality}} &\equiv \tilde{\Omega}^{\mathrm{ego}}{\mathrm{causality:profit}} \cup \tilde{\Omega}^{\mathrm{ego}}{\mathrm{causality:threat}} \cup \tilde{\Omega}^{\mathrm{ego}}{\mathrm{causality:neutral}} \
    \tilde{\Omega}^{\mathrm{ego}}{\mathrm{effect}} &\equiv \tilde{\Omega}^{\mathrm{ego}}{\mathrm{effect:profit}} \cup \tilde{\Omega}^{\mathrm{ego}}{\mathrm{effect:threat}} \cup \tilde{\Omega}^{\mathrm{ego}}{\mathrm{effect:neutral}}
\end{align}
end{align}
